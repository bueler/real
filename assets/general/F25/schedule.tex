...
\noindent for details about everything.  Classes are MWF 1:00--2:00pm, Chapman 104.  \due{Homework} due dates and \ee{Exam} dates are shown below.  Homework is due at the start of class.  Textbook chapters are in black.  Note \dlinline{deadlines}, \vacinline{no class} days, and dates Ed is in Sweden \includegraphics[width=12px]{sweden.png}.  When I am in Sweden the class will mostly switch to remote-by-zoom.
...
\wkday{8}{10/13}{10/17}  & \phantom{x} \par \due{Assignment 5} &  & 3 \\ \hline

\wkday{9}{10/20}{10/24}  & \phantom{x} \par \due{Assignment 6} &  & 4 \\ \hline
