...
\noindent for \due{Homework} and \ee{Exam} details.  Classes are MWF 1:00--2:00pm, Chapman 104.  Homework is due at the start of class.  Note \dlinline{deadlines}, \vacinline{no class} days, and dates Ed is in Sweden \includegraphics[width=12px]{sweden.png} (when class will switch to remote-by-zoom).
